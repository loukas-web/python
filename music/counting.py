...
path = "/mnt/2A548B6774E73BFC/MyMusic/mp3/export_with_warnings/"
...
for file in file_list:
    try:
        ...
        duration.append(parse.audio_tracks[0].duration)
    except IndexError as e:
        print(file, e)

print({_ for _ in sampling_rate})
print({_ for _ in channels})
print(len(file_list), len(sampling_rate), len(channels), len(duration))